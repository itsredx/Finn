...
import { ArrowBackIcon, SendIcon } from "../components/Icons";
...
const VirtualAccountDetailsPage: React.FC<VirtualAccountDetailsPageProps> = ({
  account,
  onNavigate,
  onDelete,
  isVerified = false,
}) => {
  const [isSimulateDepositModalOpen, setIsSimulateDepositModalOpen] =
    useState(false);
        ...
        <main className="p-8 lg:p-16">
          <div className="max-w-7xl mx-auto space-y-8">
            <div className="flex justify-between items-center">
              ...
              <button
                onClick={() => onNavigate("virtual-accounts")}
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-200">
              <div className="space-y-8">
                <div>
                  <h3 className="text-2xl font-bold text-[#214D76] mb-6">
                    {account.accountName}
                  </h3>
