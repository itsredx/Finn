...
const KycPage: React.FC<KycPageProps> = ({
  onNavigate,
  isVerified = false,
}) => {
  const currentKycStatus = isVerified
    ? KycStatus.Approved
        ...
        <div className="max-w-7xl mx-auto space-y-12">
          ...
          <div>
            ...
            <p className="text-lg text-gray-500 mt-2">
              Please provide your business details for verification. Your data
              is secure with us.
            </p>
          </div>
          <button
          ...
          <section className="space-y-6">
            <h2 className="text-3xl font-bold text-[#214D76]">
              Business Information Form
            </h2>
          ...
          <div className="flex items-center justify-start gap-6 pt-6">
            <button
              disabled={isVerified}
              className={`font-semibold py-3 px-10 rounded-lg shadow-md transition-colors ${
                isVerified
                  ? "bg-gray-200 text-gray-500 cursor-not-allowed"
                  : "bg-[#00B894] text-white hover:bg-opacity-90"
              }`}
            >
              Submit KYC
            </button>
